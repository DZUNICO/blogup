...
tags:
  ...
  - "#cableindeco"
---
## La Importancia del Cable en una Instalación Eléctrica Domiciliaria

La selección del cable o conductor eléctrico es una parte fundamental en la instalación eléctrica de una casa, instalar un cable de calidad y adecuado evitará que tu vivienda pueda correr riesgos, un cable inadecuado puede sobrecalentarse y provocar un cortocircuito, un incendio o incluso descargas eléctricas. Si se utiliza un cable de calibre insuficiente, se produce una mayor resistencia eléctrica, lo que puede resultar en una caída de voltaje excesiva y una pérdida de energía. Esto no solo afecta el rendimiento de los dispositivos eléctricos, sino que también conduce a un mayor consumo de energía.

> Los mejores conductores eléctricos son los que están fabricados con cobre o tienen mayor 
> pureza de cobre, en el Perú las marcas más reconocidas son **Indeco, Celsa, Elcope y Brande**. 
